...
use ockam::{Context, route, TcpTransport, TCP};
...
impl InletCommand {
    pub async fn run(
        ...
        tcp.create_inlet(inlet_host_port, route_to_outlet).await.unwrap();
        ...
        table
            ...
            .add_row(vec![inlet_host_port, format!("{} ({})", outlet_host_port, outlet_name).as_str()]);
